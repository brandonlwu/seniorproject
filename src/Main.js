      ...
      <div className='header'>
        ...
        <div className='photo-board'>
          ...
          <div className='col-placard'>
            ...
            <p className = 'col-text'>“It was towards high school graduation. The date was March 29th and he gave me a letter. Letters were very important
            during our courtship because once we graduated from high school, we were in different cities. We have a whole trunk of written letters. I wrote
            around 400. ”</p>
            </div>

            <div className='col-placard'>
              <button className = 'undecorated-button'
              onClick={() => expandStory()}
              >
            ...
            <div className='col-placard'>
              <img src={require('./assets/pic7.png')} className='col-img'/>
            </div>
          </div>
          <div className='col'>
            <div className='col-placard'>
